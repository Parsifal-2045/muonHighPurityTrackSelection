...
_ap.add_argument("--data-dir", required=True, help="directory with the seeds-chain training n-tuples")

# Configuration
CFG = dict(
    data_dir=_ap.parse_args().data_dir,  # seeds-chain training n-tuples
...
# These constants/helpers are assumed to already exist at module scope
# in your model.py — listed here only so this file is self-documenting.
# Do NOT redefine them; just paste the function body below.
#
#   log_features, plain_features, LABEL_FIELD            (module constants)
#   delta_phi, impute_and_log, impute_linear             (module helpers)
#   import numpy as np
#   import awkward as ak
