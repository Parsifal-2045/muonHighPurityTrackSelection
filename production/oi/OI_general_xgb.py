"""
OI_general_xgb.py - XGBoost forest for the OI high-purity selection of muon
tracks in the seeds-selector (MkFit) HLT chain (l3_tk_OI tracks of the
seedsSelector production ntuples).
...
_OI_DNN = (
    ...
    "/RecoMuon/L3TrackFinder/data/OI_general_model.onnx"
)
